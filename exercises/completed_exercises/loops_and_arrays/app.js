...
for (var i = 0, compCount = 0;i < officeItems.length; i++){
...
// Loop through the following array and log to the console "old enough" if they are 18 or older, and "not old enough" if thy aren't 18.
  for (i = 0; i < peopleWhoWantToSeeMadMaxFuryRoad.length; i++){
      if (peopleWhoWantToSeeMadMaxFuryRoad[i].age >= 18){
          console.log(`${peopleWhoWantToSeeMadMaxFuryRoad[i].name} is old enough. This ${peopleWhoWantToSeeMadMaxFuryRoad[i].gender} can be let in `)
      } else{
        console.log(`${peopleWhoWantToSeeMadMaxFuryRoad[i].name} is not old enough. This ${peopleWhoWantToSeeMadMaxFuryRoad[i].gender} should not be let in.`)
    }
  }
